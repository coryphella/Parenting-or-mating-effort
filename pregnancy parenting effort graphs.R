...
#load workspace
load("/Users/brendanbarrett/Dropbox/Veronika Joan DSI male/final workspaces/parent_eff_preg_jan30.rdata")
...
##link for plac2
LF2 <- link(p_preg2, n=1000 , data=d.pred_father1, replace=
...
##link for plac4
LF4 <- link(p_preg4, n=1000 , data=d.pred_father1, replace=
...
##make sure intercepts only model gets zero of weight
compare(p_preg0,p_preg2,p_preg4)

w <- compare(p_preg2,p_preg4 , sort=FALSE)@output$weight  ##extract weights from table, alphabetically ordered, important to keep models in alph ordered so proper weights are attributed
...
PF2 <- (1-LF2$p)*LF2$mu #for p_preg2
PF4 <- (1-LF4$p)*LF4$mu #for p_preg4
...
########no dad mavg preds
LN2 <- link(p_preg2, n=1000 , data=d.pred_nodad1, replace=
	list(ap_id=a_prt1_z, am_id=a_prt1_z, ap_dyad=a_dyad_z, am_dyad=a_dyad_z, bpf_id=a_prt1_z, 
		bmf_id=a_prt1_z, bpr_id=a_prt1_z, bmr_id=a_prt1_z, bpn_id=a_prt1_z, bmn_id=a_prt1_z), WAIC=TRUE)

##link for plac4
LN4 <- link(p_preg4, n=1000 , data=d.pred_nodad1, replace=
list(ap_id=a_prt1_z, am_id=a_prt1_z, am_dyad=a_dyad_z,ap_dyad=a_dyad_z,bpf_id=a_prt1_z,bmf_id=a_prt1_z,
		bpfr_id=a_prt1_z,bmfr_id=a_prt1_z,bpr_id=a_prt1_z,bmr_id=a_prt1_z,bpn_id=a_prt1_z,
		bmn_id=a_prt1_z,bpnr_id=a_prt1_z,bmnr_id=a_prt1_z), WAIC=TRUE)

#generate predictions from each model that will be averaged
PN2 <- (1-LN2$p)*LN2$mu #for p_preg2
PN4 <- (1-LN4$p)*LN4$mu #for p_preg4
...
LX2 <- link(p_preg2, n=1000 , data=d.pred_nextdad1, replace=
	list(ap_id=a_prt1_z, am_id=a_prt1_z, ap_dyad=a_dyad_z, am_dyad=a_dyad_z, bpf_id=a_prt1_z, 
		bmf_id=a_prt1_z, bpr_id=a_prt1_z, bmr_id=a_prt1_z, bpn_id=a_prt1_z, bmn_id=a_prt1_z), WAIC=TRUE)
##link for plac4
LX4 <- link(p_preg4, n=1000 , data=d.pred_nextdad1, replace=
list(ap_id=a_prt1_z, am_id=a_prt1_z, am_dyad=a_dyad_z,ap_dyad=a_dyad_z,bpf_id=a_prt1_z,bmf_id=a_prt1_z,
		bpfr_id=a_prt1_z,bmfr_id=a_prt1_z,bpr_id=a_prt1_z,bmr_id=a_prt1_z,bpn_id=a_prt1_z,
		bmn_id=a_prt1_z,bpnr_id=a_prt1_z,bmnr_id=a_prt1_z), WAIC=TRUE)

#generate predictions from each model that will be averaged
PX2 <- (1-LX2$p)*LX2$mu #for p_preg2
PX4 <- (1-LX4$p)*LX4$mu #for p_preg4
...
pdf("Posterior_Mean_DSIs_Male_Father_Status_pregnant_Females.pdf", height=7,width=7)

#Plot
par(mfrow=c(1,1) , mar=c(0,0,0,0) , oma=c(0,0,0,0))
dens(pred_nodad, xlim=c(0,max(d$DSI)+1) , xlab=NA , ylab=NA , col="white"  , xaxt='n' ,  yaxt='n', zero.line = FALSE,ylim=c(-0.12,4.2))
...
mtext(side=1,line=1.25,cex=1.4,text="dyadic sociality index (DSI): pregnant")
#points below
...
LR2 <- link(p_preg2, n=1000 , data=d.pred_rank1, replace=
	list(ap_id=a_prt1_z, am_id=a_prt1_z, ap_dyad=a_dyad_z, am_dyad=a_dyad_z, bpf_id=a_prt1_z, 
		bmf_id=a_prt1_z, bpr_id=a_prt1_z, bmr_id=a_prt1_z, bpn_id=a_prt1_z, bmn_id=a_prt1_z), WAIC=TRUE)

##link for plac4
LR4 <- link(p_preg4, n=1000 , data=d.pred_rank1, replace=
list(ap_id=a_prt1_z, am_id=a_prt1_z, am_dyad=a_dyad_z,ap_dyad=a_dyad_z,bpf_id=a_prt1_z,bmf_id=a_prt1_z,
		bpfr_id=a_prt1_z,bmfr_id=a_prt1_z,bpr_id=a_prt1_z,bmr_id=a_prt1_z,bpn_id=a_prt1_z,
		bmn_id=a_prt1_z,bpnr_id=a_prt1_z,bmnr_id=a_prt1_z), WAIC=TRUE)

#generate predictions from each model that will be averaged, this is a vector
PR2 <- (1-LR2$p)*LR2$mu #for p_preg2
PR4 <- (1-LR4$p)*LR4$mu #for p_preg4
...
#Plot rank
pdf("Rank_Effect_All Males_pregnant_Females_Shade89CI.pdf", height=7,width=7)
par(mar=c(3.5,3.5,0.5,1.5))
plot( DSI ~ s_rank , data=d , col=alpha("black",0.5),pch=16 ,ylim=c(0,11),ylab='',xlab='')
...
pdf("Rank_Effect_All Males_pregnant_Females_Indiv_Preds.pdf", height=7,width=7)
par(mar=c(3.5,3.5,0.5,1.5))
plot( DSI ~ s_rank , data=d , col=alpha("black",0.5),pch=16 ,ylim=c(0,11),ylab='',xlab='') #plot main effect
mtext("rank of male in dyad", side=1, line=2, cex=1.4)
mtext("dyadic sociality index (DSI)", side=2, line=2, cex=1.4)
...
LR2 <- link(p_preg2, n=1000 , data=d.pred_slope,replace=
...
LR4 <- link(p_preg4, n=1000 , data=d.pred_slope,replace=
...
LR2 <- link(p_preg2, n=1000 , data=d.pred_father3 , replace=
	list(ap_id=a_prt1_z, am_id=a_prt1_z, ap_dyad=a_dyad_z, am_dyad=a_dyad_z, bpf_id=a_prt1_z, 
		bmf_id=a_prt1_z, bpr_id=a_prt1_z, bmr_id=a_prt1_z, bpn_id=a_prt1_z, bmn_id=a_prt1_z), WAIC=TRUE)

##link for plac4
LR4 <- link(p_preg4, n=1000 , data=d.pred_father3 , replace=
list(ap_id=a_prt1_z, am_id=a_prt1_z, am_dyad=a_dyad_z,ap_dyad=a_dyad_z,bpf_id=a_prt1_z,bmf_id=a_prt1_z,
		bpfr_id=a_prt1_z,bmfr_id=a_prt1_z,bpr_id=a_prt1_z,bmr_id=a_prt1_z,bpn_id=a_prt1_z,
		bmn_id=a_prt1_z,bpnr_id=a_prt1_z,bmnr_id=a_prt1_z), WAIC=TRUE)
...
#nodad
LR2 <- link(p_preg2, n=1000 , data=d.pred_nodad3 , replace=
	list(ap_id=a_prt1_z, am_id=a_prt1_z, ap_dyad=a_dyad_z, am_dyad=a_dyad_z, bpf_id=a_prt1_z, 
		bmf_id=a_prt1_z, bpr_id=a_prt1_z, bmr_id=a_prt1_z, bpn_id=a_prt1_z, bmn_id=a_prt1_z), WAIC=TRUE)

##link for plac4
LR4 <- link(p_preg4, n=1000 , data=d.pred_nodad3 , replace=
list(ap_id=a_prt1_z, am_id=a_prt1_z, am_dyad=a_dyad_z,ap_dyad=a_dyad_z,bpf_id=a_prt1_z,bmf_id=a_prt1_z,
		bpfr_id=a_prt1_z,bmfr_id=a_prt1_z,bpr_id=a_prt1_z,bmr_id=a_prt1_z,bpn_id=a_prt1_z,
		bmn_id=a_prt1_z,bpnr_id=a_prt1_z,bmnr_id=a_prt1_z), WAIC=TRUE)
...
##nextdad
LR2 <- link(p_preg2, n=1000 , data=d.pred_nextdad3 , replace=
	list(ap_id=a_prt1_z, am_id=a_prt1_z, ap_dyad=a_dyad_z, am_dyad=a_dyad_z, bpf_id=a_prt1_z, 
		bmf_id=a_prt1_z, bpr_id=a_prt1_z, bmr_id=a_prt1_z, bpn_id=a_prt1_z, bmn_id=a_prt1_z), WAIC=TRUE)

##link for plac4
LR4 <- link(p_preg4, n=1000 , data=d.pred_nextdad3 , replace=
list(ap_id=a_prt1_z, am_id=a_prt1_z, am_dyad=a_dyad_z,ap_dyad=a_dyad_z,bpf_id=a_prt1_z,bmf_id=a_prt1_z,
		bpfr_id=a_prt1_z,bmfr_id=a_prt1_z,bpr_id=a_prt1_z,bmr_id=a_prt1_z,bpn_id=a_prt1_z,
		bmn_id=a_prt1_z,bpnr_id=a_prt1_z,bmnr_id=a_prt1_z), WAIC=TRUE)
...
#plot rank
pdf("Rank_Interaction_Triptych_Males_pregnant_Females.pdf", height=3.25,width=8)
...
par(mar=c(1,0,0,0))
plot( DSI[d$nodad==1] ~ s_rank[d$nodad==1] , data=d , col=alpha("orange",0.5),pch=16 ,ylim=c(0,11),ylab='',xlab='',xlim=c(min(d$s_rank),max(d$s_rank)), yaxt='n')
...
par(mar=c(1,0,0,0))
plot( DSI[d$nextdad==1] ~ s_rank[nextdad==1] , data=d , col=alpha("red",0.5),pch=16 ,ylim=c(0,11),ylab='',xlab='',xlim=c(min(d$s_rank),max(d$s_rank)), yaxt='n')
...
pdf("Rank_Interaction_Triptych_Males_pregnant_Females_Indiv_Preds.pdf", height=3.25,width=8)
...
LR2 <- link(p_preg2, n=1000 , data=d.pred_father.s , replace=
	list(ap_dyad=a_dyad_z, am_dyad=a_dyad_z, bpn_id=a_prt1_z, bmn_id=a_prt1_z), WAIC=TRUE)
##link for plac4
LR4 <- link(p_preg4, n=1000 , data=d.pred_father.s , replace=
...
par(mar=c(1,0,0,0))
plot( DSI[d$nodad==1] ~ s_rank[d$nodad==1] , data=d , col=alpha("red",0.5),pch=16 ,ylim=c(0,11),ylab='',xlab='',xlim=c(min(d$s_rank),max(d$s_rank)), yaxt='n')
...
LR2 <- link(p_preg2, n=1000 , data=d.pred_nodad.s , replace=
	list(ap_dyad=a_dyad_z, am_dyad=a_dyad_z, bpf_id=a_prt1_z, 
		bmf_id=a_prt1_z, bpn_id=a_prt1_z, bmn_id=a_prt1_z), WAIC=TRUE)

##link for plac4
LR4 <- link(p_preg4, n=1000 , data=d.pred_nodad.s , replace=
		list(am_dyad=a_dyad_z,ap_dyad=a_dyad_z,bpf_id=a_prt1_z,bmf_id=a_prt1_z,
		bpfr_id=a_prt1_z,bmfr_id=a_prt1_z,bpn_id=a_prt1_z,
		bmn_id=a_prt1_z,bpnr_id=a_prt1_z,bmnr_id=a_prt1_z), WAIC=TRUE)
...
par(mar=c(1,0,0,0))
plot( DSI[d$nextdad==1] ~ s_rank[nextdad==1] , data=d , col=alpha("orange",0.5),pch=16 ,ylim=c(0,11),ylab='',xlab='',xlim=c(min(d$s_rank),max(d$s_rank)),yaxt='n')
lines( rank.seq , pred.median3 )
text(0,11,"a. male sires next infant", cex=1.2)
...
LR2 <- link(p_preg2, n=1000 , data=d.pred_nextdad.s , replace=
	list( ap_dyad=a_dyad_z, am_dyad=a_dyad_z, bpf_id=a_prt1_z,bmf_id=a_prt1_z), WAIC=TRUE)

##link for plac4
LR4 <- link(p_preg4, n=1000 , data=d.pred_nextdad.s , replace=
list( am_dyad=a_dyad_z,ap_dyad=a_dyad_z,bpf_id=a_prt1_z,bmf_id=a_prt1_z,
...
##########################################################################
#Plot Bernoulli and gamma components separately
...
#plot rank
pdf("p_mu_rank_allmales_pregnant.pdf", height=7,width=7)
...
#Plot
pdf("p_mu_rank_posteriors_pregnancy.pdf", height=7,width=7)
